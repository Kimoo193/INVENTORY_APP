    ...
    setState(() {
      _filtered = query.isEmpty
          ...
          : _items.where((item) =>
              ...
              item.warehouseName.toLowerCase().contains(query.toLowerCase())).toList();
    });
  }
  ...
  Future<void> _deleteItem(InventoryItem item) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('هتحذف "${item.productName}"؟'),
        actions: [
      ...
      child: Column(
        children: [
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _searchController.text.isNotEmpty
                    ? IconButton(icon: const Icon(Icons.clear, size: 20), onPressed: () { _searchController.clear(); _search(''); })
                    : null,
          ...
          Padding(
            ...
            child: Row(children: [
              Text('${_filtered.length} قطعة', style: const TextStyle(color: Colors.grey, fontSize: 12)),
            ]),
          ),
          Expanded(
            child: _loading
                ...
                : _filtered.isEmpty
                    ? Center(
                        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text('لا توجد عناصر', style: TextStyle(color: Colors.grey.shade400, fontSize: 16)),
                        ]),
                      )
                    : RefreshIndicator(
                          ...
                          itemBuilder: (ctx, i) {
                            ...
                            return Card(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  final result = await Navigator.push(context, MaterialPageRoute(builder: (_) => AddItemScreen(itemToEdit: item)));
                                  ...
                                  child: Row(
                                    children: [
                                      Container(
                                        width: 4,
                                        height: 56,
                                        decoration: BoxDecoration(color: condColor, borderRadius: BorderRadius.circular(4)),
                                      ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Row(children: [
                                              ...
                                              Expanded(child: Text(item.warehouseName, style: TextStyle(fontSize: 11, color: Colors.grey.shade600), overflow: TextOverflow.ellipsis)),
                                            ]),
                                            if (item.serial != null) Row(children: [
                                              Icon(Icons.qr_code, size: 12, color: Colors.grey.shade500),
                                              const SizedBox(width: 3),
                                              Text(item.serial!, style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
                                            ]),
                                            if (item.notes != null) Row(children: [
                                              Icon(Icons.notes, size: 12, color: Colors.grey.shade500),
                                              const SizedBox(width: 3),
                                              Expanded(child: Text(item.notes!, style: TextStyle(fontSize: 11, color: Colors.grey.shade600), overflow: TextOverflow.ellipsis)),
                                            ]),
                                          ],
                                        ),
                                      ),
                                      Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Text(item.condition, style: TextStyle(color: condColor, fontWeight: FontWeight.bold, fontSize: 12)),
                                          ),
